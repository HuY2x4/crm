...
If subAction = "searchItem" Then
    Dim cCompany,cLinkman,cTel,cArea,cSquare,cStart,cType,cSource,cUser,cTimeBegin,cTimeEnd,cETimeBegin,cETimeEnd,SHYN
...
If cCompany = "" And cLinkman = ""  And cMobile = "" And cTel = "" And cArea = "" And cSquare = ""  And cType = "" And cSource = "" And cUser = "" And cStart = "" And cTimeBegin = "" And cTimeEnd = "" And cETimeBegin = "" And cETimeEnd = "" And SHYN = "" Then
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_1">
							...
							<tr class="tr">
								...
								<%if rs("cOldUser")="" or IsNull(rs("cOldUser")) then%>
									...
									<%end if%>
								<%else%>
								<% If mid(Session("CRM_qx"), 16, 1) = 1 Then %>
