...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td valign="top" class="td_n pdr10">   
            <div class="MenuboxS">
              <ul>
                <li style="margin-top:10px;" <%if otype="Select_Type" then%>class="hover"<%end if%>><span><a href="?otype=Select_Type">客户类型</a></span></li>
                <li style="margin-top:10px;" <%if otype="Select_Source" then%>class="hover"<%end if%>><span><a href="?otype=Select_Source">客户来源</a></span></li>
				<li style="margin-top:10px;" <%if otype="Select_Industry" then%>class="hover"<%end if%>><span><a href="?otype=Select_Industry">客户行业</a></span></li>
                ...
                <li style="margin-top:10px;" <%if otype="Select_Service" then%>class="hover"<%end if%>><span><a href="?otype=Select_Service">交流情况</a></span></li><!--old 售后类型 by Bob-->
                ...
                <li style="margin-top:10px;" <%if otype="Select_ExpenseOUT" then%>class="hover"<%end if%>><span><a href="?otype=Select_ExpenseOUT">客户状态</a></span></li><!--old 支出类型 by Bob-->
