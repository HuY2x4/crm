				...
				<tr>
					<td valign="top" class="td_n pdl10 pdr10 pdt10"> 
						<table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
                            ...
                            <tr> 
                                <td class="td_l_c title">25.</td>
								<td class="td_l_c"> <%=L_Client_cIndustry%></td>
								<td class="td_l_c"><input name="Client_cIndustry" type="checkbox" id="Client_cIndustry" value="1" <%if Client_cIndustry = 1 then %>checked<%end if%> ></td>
...
elseif sType="SaveListAll" then
		...
		Client_cSNum = 0
		END IF
        IF Request.Form("Client_cIndustry") <> "" THEN
		Client_cIndustry = Request.Form("Client_cIndustry")
		ELSE
		Client_cIndustry = 0
		END IF
        ...
        TempStr = TempStr & "Client_cIndustry="& Client_cIndustry &"" & VbCrLf
					...
					<td valign="top" class="td_n pdl10 pdr10 pdt10"> 
						<table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
							...
							<tr> 
								...
								<tr> 
								<td class="td_l_c title">21.</td>
								<td class="td_l_c"> <%=L_Client_cWechat%></td>
								<td class="td_l_c"><input name="Must_Client_cWechat" type="checkbox" id="Must_Client_cWechat" value="1" <%if Must_Client_cWechat = 1 then %>checked<%end if%> ></td>
								<td class="td_l_c title">22.</td>
								<td class="td_l_c"> <%=L_Client_cPosition%></td>
								<td class="td_l_c"><input name="Must_Client_cPosition" type="checkbox" id="Must_Client_cPosition" value="1" <%if Must_Client_cPosition = 1 then %>checked<%end if%> ></td>
								<td class="td_l_c title">23.</td>
								<td class="td_l_c"> <%=L_Client_cIndustry%></td>
								<td class="td_l_c"><input name="Must_Client_cIndustry" type="checkbox" id="Must_Client_cIndustry" value="1" <%if Must_Client_cIndustry = 1 then %>checked<%end if%> ></td>
								<td class="td_l_c title"></td>
								<td class="td_l_c"> </td>
								<td class="td_l_c"></td>
							</tr>
...
elseif sType="ClientAddSave" then
		...
		IF Request.Form("Must_Client_cWechat") <> "" THEN 'by Bob
		Must_Client_cWechat = Request.Form("Must_Client_cWechat")
		ELSE
		Must_Client_cWechat = 0
		END IF
		IF Request.Form("Must_Client_cPosition") <> "" THEN 'by Bob
		Must_Client_cPosition = Request.Form("Must_Client_cPosition")
		ELSE
		Must_Client_cPosition = 0
		END IF
		IF Request.Form("Must_Client_cIndustry") <> "" THEN 'by Bob
		Must_Client_cIndustry = Request.Form("Must_Client_cIndustry")
		ELSE
		Must_Client_cIndustry = 0
		END IF
		...
		TempStr = TempStr & "Must_Client_cWechat="& Must_Client_cWechat &"" & VbCrLf 'by Bob
		TempStr = TempStr & "Must_Client_cPosition="& Must_Client_cPosition &"" & VbCrLf 'by Bob
		TempStr = TempStr & "Must_Client_cIndustry="& Must_Client_cIndustry &"" & VbCrLf 'by Bob
					...
					<td valign="top" class="td_n pdl10 pdr10 pdt10"> 
						<table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
							...
							<tr> 
								...
								<td class="td_l_c"><input name="Records_rVisitTime" type="checkbox" id="Records_rVisitTime" value="1" <%if Records_rVisitTime = 1 then %>checked<%end if%> > </td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td valign="top" class="td_n pdl10 pdr10 pdt10"> 
						<table width="100%" border="0" cellspacing="0" cellpadding="0" CLASS="table_1">
							...
							<tr> 
								...
								<td class="td_l_c title">6.</td>
								<td class="td_l_c"><%=L_Records_rVisitTime%> </td>
								<td class="td_l_c"> <input name="Must_Records_rVisitTime" type="checkbox" id="Must_Records_rVisitTime" value="1" <%if Must_Records_rVisitTime = 1 then %>checked<%end if%> ></td>
								<td class="td_l_c title"></td>
								<td class="td_l_c"> </td>
								<td class="td_l_c"> </td>
								<td class="td_l_c title"></td>
...
elseif sType="SaveRecords" then
		...
		ELSE
		 Records_rTime= 0
		END IF
        IF Request.Form("Records_rVisitTime") <> "" THEN
		 Records_rVisitTime= Request.Form("Records_rVisitTime")
		ELSE
		 Records_rVisitTime= 0
		END IF
		...
		END IF
        IF Request.Form("Must_Records_rVisitTime") <> "" THEN
		 Must_Records_rVisitTime= Request.Form("Must_Records_rVisitTime")
		ELSE
		 Must_Records_rVisitTime= 0
		END IF
        ...
        TempStr = TempStr & "Records_rVisitTime="& Records_rVisitTime &"" & VbCrLf
		...
		TempStr = TempStr & "Must_Records_rVisitTime="& Must_Records_rVisitTime &"" & VbCrLf
		TempStr = TempStr & "%" & chr(62) & VbCrLf
