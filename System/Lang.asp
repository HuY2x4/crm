  ...
  <tr>
    <td valign="top" class="td_n pdl10 pdr10 pdt10"> 
	  ...
	  <col width="200" /><col width="450" />
        ...
        <tr class="tr"> 
			<td class="td_l_l">L_Records_rVisitTime</td>
			<td class="td_l_l"> <input name="L_Records_rVisitTime" type="text" id="Text1" class="int" value="<%=L_Records_rVisitTime%>" size="60"></td>
			<td class="td_l_l">联系时间</td>
        </tr>
      </table>
    </td> 
  </tr>
...
<% '保存跟单字段
	If action="SaveRecords" then
        ...
        TempStr = TempStr & "L_Records_rVisitTime="& Chr(34) & replace(Trim(Request.Form("L_Records_rVisitTime")),CHR(34),"'") & Chr(34) &" " & VbCrLf
		TempStr = TempStr & "%" & chr(62) & VbCrLf
