            ...
            <li class="widget color-4">  
                ...
                <div class="widget-content">
					<ul>
						...
						<script>function Records_InfoView<%=rs1("rId")%>() {$.dialog.open('GetUpdate.asp?action=Client&sType=InfoView&oType=Records&cId=<%=rs1("cId")%>', {title: '查看', width: 900,height: 580, fixed: true}); };</script>
						<%
						  rs1.movenext
						  loop
						  end if
